...
export class Configuration {
  public static basedURL = 'https://nrrt.azurewebsites.net/v1/api';
  ...
  public static acuteKidneyInjuryRiskAssessmentURL = `${this.basedURL}/acutekidneyinjuryriskassessment`;
